...
// console.log(jonas['lastName']);//braker notation here
...
// calcAge: function(){ //property
//   this.age = 2027 - this.birthYeah;
//   return this.age;
// },

// getSummary: function(){
//    return `${jonas.firstName} is a ${this.calcAge()} -years old ${jonas.job}, and he has ${this.hasDriversLicense ?'a':'no'} driver's license`
// }
// };
